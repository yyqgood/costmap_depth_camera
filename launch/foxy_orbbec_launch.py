...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'costmap_orbbec_camera_params.yaml'),
    ...
    start_rviz_cmd = Node(
        ...
        executable='rviz2',
        output='screen',
        arguments=['-d', os.path.join(bringup_dir, 'rviz', 'orbbec_test.rviz')]
    )
    ...
    ld.add_action(tf_baselink2camera_node)
